...
Write-Host "║                                                          ║" -ForegroundColor Cyan
Write-Host "║      🎉  Junior Framework Deployment Complete! 🎉     ║" -ForegroundColor Green
Write-Host "║                                                          ║" -ForegroundColor Cyan
Write-Host "║             ✅ All steps finished successfully! ✅         ║" -ForegroundColor Green
Write-Host "║                                                          ║" -ForegroundColor Cyan
Write-Host "║          🔐 Check your .env file for user credentials.    ║" -ForegroundColor Yellow
Write-Host "║                                                          ║" -ForegroundColor Cyan
Write-Host "║              🚀 Ready to process your data pipelines!      ║" -ForegroundColor Green
Write-Host "║                                                          ║" -ForegroundColor Cyan
Write-Host "╚══════════════════════════════════════════════════════════╝" -ForegroundColor Cyan
Write-Host ""
